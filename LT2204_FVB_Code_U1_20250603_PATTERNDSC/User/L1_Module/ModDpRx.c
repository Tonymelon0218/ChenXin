...
u8 Chip_DpRx_JudgeTimingHBE(void)
{
    ...
    if ((Chip_Timing_Check(stRxTimingInfo) == HBE_4K60) && (stRxTimingInfo.usVtol == 2250) && (stRxTimingInfo.usHact == 3840) && (stRxTimingInfo.usVact == 2160))
    {
        g_stDpRx.b2IsTimingHBE = HBE_TYPE_UHD_60Hz;
    }
    else if (((Chip_Timing_Check(stRxTimingInfo) == HBE_4K50) && (stRxTimingInfo.usVtol == 2250) && ((stRxTimingInfo.usHact == 3840) || (stRxTimingInfo.usHact == 4096)) && (stRxTimingInfo.usVact == 2160)))
    {
